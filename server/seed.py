from models import db, Core, Middle, Outer, Vulnerability, Biology, Physiology  # Import database instance and models
...
def seed_database():
    with app.app_context():
        ...
        Biology.query.delete()
        Physiology.query.delete()
